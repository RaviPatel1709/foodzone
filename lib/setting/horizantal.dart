...
class _HorizontalListViewExampleState extends State<HorizontalListViewExample> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Horizontal List with Tappable Image and Text"),
        ...
        children:[Row(
            children: categories.map((category) {
              return Column(
                ...
                children: [
                  // GestureDetector for first image and text
                  GestureDetector(
                    onTap: () {
                  ...
                  // GestureDetector for second image and text
                  GestureDetector(
                    onTap: () {
...
class DetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Text('Detail of $title', style: TextStyle(fontSize: 20)),
      ),
    );
  }
}
...
void main() {
  runApp(MaterialApp(
    home: HorizontalListViewExample(),
  ));
}
